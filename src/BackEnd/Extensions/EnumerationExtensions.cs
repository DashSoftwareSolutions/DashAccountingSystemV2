...
namespace DashAccountingSystemV2.BackEnd.Extensions
{
    ...
    public static class EnumerationExtensions
    {
        ...
        /// <summary>
        /// Gets the Name property of an enum value that is decorated with a <see cref="DisplayAttribute"/> and Name is not null or empty.
        ...
        /// <summary>
        /// Gets the Description property of an enum value that is decorated with a <see cref="DisplayAttribute"/> and Name is not null or empty.
        /// Returns the default string conversion of the enum value otherwise.
        /// </summary>
        /// <typeparam name="TEnum">Must be a type of enum</typeparam>
        /// <param name="enumValue">Enum value</param>
        ...
        /// <summary>
        /// Gets the Order property of an enum value that is decorated with a <see cref="DisplayAttribute"/> if it is not null; returns the underlying enum integer value otherwise.
        /// </summary>
        /// <typeparam name="TEnum">Must be a type of enum</typeparam>
        /// <param name="enumValue">Enum value</param>
        ...
        /// <summary>
        /// Gets the <see cref="DisplayAttribute"/> from an enum value.
        /// </summary>
        /// <typeparam name="TEnum">Must be a type of enum</typeparam>
        /// <param name="enumValue">Enum value</param>
        /// <returns><see cref="DisplayAttribute"/> if found or null otherwise</returns>
        ...
        /// </summary>
        /// <typeparam name="TEnum">Must be a type of enum</typeparam>
        /// <typeparam name="TAttribute">Must be a type of <see cref="Attribute"/></typeparam>
        /// <param name="enumValue">Enum value</param>
