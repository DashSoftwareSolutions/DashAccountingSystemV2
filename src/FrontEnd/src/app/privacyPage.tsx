    ...
    return (
        <Row className="mt-4">
            ...
            <Col>
                ...
                <p>
                    Please read this privacy policy (&ldquo;ccookie policy&rdquo;, &ldquo;policy&rdquo;) carefully
                    before using the Dash Accounting System website (&odquo;website&rdquo;, &ldquo;service&rdquo;, &ldquo;system&rdquo;)
                    operated by Dash Software Solutions, Inc. (&ldquo;us&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;).
                </p>
                ...
                <p>
                    Cookies are simple text files that are stored on your computer or mobile device by a website&rsquo;s
                    server. Each cookie is unique to your web browser. It will contain some anonymous information such as
                    a unique identifier, the website&rsquo;s domain name, and some digits and numbers.
                </p>
                ...
                <p>
                    Privacy policy adapted from <a href="https://www.websitepolicies.com/blog/sample-cookie-policy-template">https://www.websitepolicies.com/blog/sample-cookie-policy-template</a>.
                </p>
            </Col>
        </Row>
    );
